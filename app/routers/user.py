...
from app.models.models_user import UserCreate, UserUpdate, UserResponseModel, UserList, UserDeleteResponse, \
    UserSignInRequest
...
@user_router.post('/sign_in', response_model=UserDeleteResponse)
async def create_user(data: UserSignInRequest, user_service: UserService = Depends(get_user_service)) -> Dict[str, str]:
